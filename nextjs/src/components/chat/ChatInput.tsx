...
export function ChatInput(): React.JSX.Element {
  ...
  // Wrapper to match InputForm's expected signature
  const handleInputFormSubmit = (query: string, pdfFile?: File | null) => {
    // You may ignore pdfFile or handle it as needed
    handleSubmit(query);
  };
